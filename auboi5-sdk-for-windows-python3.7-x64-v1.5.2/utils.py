...
class Auboi5Robot:
    ...
    def move_rotate(self, user_coord, rotate_axis, rotate_angle):
        ...
        * NOTES:
        ...
        self.check_event()
        if self.rshd >= 0 and self.connected:
            # logger.warn(f'self.rshd, user_coord, rotate_axis, rotate_angle: {self.rshd, user_coord, rotate_axis, rotate_angle}')
            
            return libpyauboi5.move_rotate(self.rshd, user_coord, list(rotate_axis), rotate_angle)
    ...
    def base_to_base_additional_tool(self, flange_pos, flange_ori, user_tool):
        ...
        * NOTES:
        """
        # 实际调用libpyauboi5的base_to_base_additional_tool
